<div id="trp-addons-page" class="wrap">
    ...
    <div class="grid feat-header">
        <div class="grid-cell">
            <h2><?php esc_html_e('Optimize eTranslation Multilingual database tables', 'translatepress-multilingual' );?> </h2>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">
                                    <?php echo wp_kses ( __( 'Removes CDATA from etm_original_strings and etm_dictionary_* tables.<br>This type of content should not be detected by eTranslation Multilingual. It might have been introduced in the database in older versions of the plugin.', 'translatepress-multilingual' ), array( 'br' => array() )  ); ?>
                                </p>
                                <br>
                                ...
                                <p class="description">
                                    <?php echo wp_kses ( __( 'Removes untranslated links and images from all etm_dictionary_* tables. These tables contain translations for user-inputted strings such as post content, post title, menus etc.', 'translatepress-multilingual' ), array( 'br' => array() )  ); ?>
                                </p>
                                <br>
                                ...
                                <p class="description">
                                    <?php echo wp_kses ( __( 'Cleans up all etm_gettext_* tables of duplicate rows. These tables contain translations for themes and plugin strings.', 'translatepress-multilingual' ), array( 'br' => array() )  ); ?>
                                </p>
                                <br>
                                ...
                                <p class="description">
                                    <?php echo wp_kses ( __( 'Cleans up all etm_dictionary_* tables of duplicate rows. These tables contain translations for user-inputted strings such as post content, post title, menus etc.', 'translatepress-multilingual' ), array( 'br' => array() )  ); ?>
                                </p>
                                <br>
