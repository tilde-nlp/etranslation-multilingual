        ...
        <div class="grid-cell">
	        ...
	        <?php if ( empty( $_GET['trp_rm_duplicates'] ) ){ ?>
                ...
                <form onsubmit="return confirm('<?php echo esc_js( __( 'IMPORTANT: It is strongly recommended to first backup the database!! Are you sure you want to continue?', 'etranslation-multilingual' ) ); ?>');">
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="trp_rm_cdata_original_and_dictionary" id="trp_rm_cdata_original_and_dictionary" checked><label for="trp_rm_cdata_original_and_dictionary"><?php esc_attr_e( 'Remove CDATA for original and dictionary strings', 'etranslation-multilingual' ); ?></label></input><br>
                                <p class="description">
                                ...
                                <br>
                                <input type="checkbox" name="trp_rm_untranslated_links" id="trp_rm_untranslated_links" checked><label for="trp_rm_untranslated_links"><?php esc_attr_e( 'Remove untranslated links from dictionary tables', 'etranslation-multilingual' ); ?></label></input><br>
                                <p class="description">
                                ...
                                <br>
                                <input type="checkbox" name="trp_rm_duplicates_gettext" id="trp_rm_duplicates_gettext" checked><label for="trp_rm_duplicates_gettext"><?php esc_attr_e( 'Remove duplicate rows for gettext strings', 'etranslation-multilingual' ); ?></label></input><br>
                                <p class="description">
                                ...
                                <br>
                                <input type="checkbox" name="trp_rm_duplicates_dictionary" id="trp_rm_duplicates_dictionary" checked><label for="trp_rm_duplicates_dictionary"><?php esc_attr_e( 'Remove duplicate rows for dictionary strings', 'etranslation-multilingual' ); ?></label></input><br>
                                <p class="description">
                                ...
                                <br>
                                <input type="checkbox" name="trp_rm_duplicates_original_strings" id="trp_rm_duplicates_original_strings" checked><label for="trp_rm_duplicates_original_strings"><?php esc_attr_e( 'Remove duplicate rows for original dictionary strings', 'etranslation-multilingual' ); ?></label></input><br>
                                <p class="description">
                    ...
                    <br>
                    <input type="submit" class="button-primary" name="trp_rm_duplicates_of_the_selected_option" value="<?php esc_attr_e( 'Optimize Database', 'etranslation-multilingual' ); ?>">
                </form>
            <?php } ?>
