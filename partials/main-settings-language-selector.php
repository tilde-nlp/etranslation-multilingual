        ...
        <table id="etm-languages-table">
            ...
            foreach ($this->settings['translation-languages'] as $key=>$selected_language_code ){
                ...
                <tr class="etm-language">
                    ...
                    <td>
                        <select name="etm_settings[translation-languages][]" class="etm-select2 etm-translation-language" <?php echo ( $default_language ) ? 'disabled' : '' ?>>
                    ...
                    <td>
                        <a class="etm-remove-language" style=" <?php echo ( $default_language ) ? 'display:none' : '' ?>" data-confirm-message="<?php esc_attr_e( 'Are you sure you want to remove this language?', 'etranslation-multilingual' ); ?>"><?php esc_html_e( 'Remove', 'etranslation-multilingual' ); ?></a>
                    </td>
                </tr>
            <?php }?>
            </tbody>
