...
<?php __("Settings saved.", "etranslation-multilingual"); ?>
<?php __("Yes", "etranslation-multilingual"); ?>
<?php __("Are you sure you want to remove this item?", "etranslation-multilingual"); ?>
<?php __("Remove", "etranslation-multilingual"); ?>
<?php __("Add", "etranslation-multilingual"); ?>
<?php __("Select...", "etranslation-multilingual"); ?>
<?php __("There is a new version of %1$s available. %2$sView version %3$s details%4$s or %5$supdate now%6$s.", "etranslation-multilingual"); ?>
...
<?php __("Restrict element to language", "etranslation-multilingual"); ?>
<?php __("Show this element only in one language.", "etranslation-multilingual"); ?>
<?php __("Enable translation", "etranslation-multilingual"); ?>
<?php __("Allow translation to the corresponding language only if the content is written in the default language.", "etranslation-multilingual"); ?>
<?php __("Select language", "etranslation-multilingual"); ?>
<?php __("Choose in which language to show this element.", "etranslation-multilingual"); ?>
<?php __("Exclude element from language", "etranslation-multilingual"); ?>
<?php __("Exclude this element from specific languages.", "etranslation-multilingual"); ?>
<?php __("Select languages", "etranslation-multilingual"); ?>
<?php __("Choose from which languages to exclude this element.", "etranslation-multilingual"); ?>
<?php __("This element will still be visible when you are translating your website through the Translation Editor.", "etranslation-multilingual"); ?>
<?php __("The content of this element should be written in the default language.", "etranslation-multilingual"); ?>
<?php __("<strong>eTranslation Multilingual</strong> encountered SQL errors. <a href=\"%s\" title=\"View eTranslation Multilingual SQL Errors\">Check out the errors</a>.", "etranslation-multilingual"); ?>
<?php __("Automatic translation has been disabled.", "etranslation-multilingual"); ?>
<?php __("Dismiss this notice.", "etranslation-multilingual"); ?>
...
<?php __("If eTranslation Multilingual detects something wrong when executing queries on your database, it may disable the Automatic Translation feature in order to avoid any extra charging by Google/DeepL. Automatic Translation needs to be manually turned on, after you solve the issues.", "etranslation-multilingual"); ?>
...
<?php __("Go to Settings -> eTranslation Multilingual -> General tab and Save Settings. This will regenerate the tables using your current SQL settings. Check if no more errors occur while browsing your website in a translated language. Look at the timestamps of the errors to make sure you are not seeing the old errors. Only the most recent 5 errors are displayed.", "etranslation-multilingual"); ?>
<?php __("Plan B.", "etranslation-multilingual"); ?>
<?php __("If your problem isn't solved, try the following steps:", "etranslation-multilingual"); ?>
<?php __("Create a backup of your database", "etranslation-multilingual"); ?>
<?php __("Create a copy of each translation table where you encounter errors. You can copy the table within the same database (etm_dictionary_en_us_es_es_COPY for example) -- perform this step only if you want to keep the current translations", "etranslation-multilingual"); ?>
<?php __("Remove the trouble tables by executing the DROP function on them", "etranslation-multilingual"); ?>
<?php __("Go to Settings -> eTranslation Multilingual -> General tab and Save Settings. This will regenerate the tables using your current SQL server.", "etranslation-multilingual"); ?>
<?php __("Copy the relevant content from the duplicated tables (etm_dictionary_en_us_es_es_COPY for example) in the newly generated table (etm_dictionary_en_us_es_es) -- perform this step only if you want to keep the current translations", "etranslation-multilingual"); ?>
...
<?php __("Plan C.", "etranslation-multilingual"); ?>
...
<?php __("Short Language Names", "etranslation-multilingual"); ?>
<?php __("Flags with Full Language Names", "etranslation-multilingual"); ?>
<?php __("Flags with Short Language Names", "etranslation-multilingual"); ?>
<?php __("Only Flags", "etranslation-multilingual"); ?>
<?php __("Full Language Names No HTML", "etranslation-multilingual"); ?>
<?php __("Bottom Right", "etranslation-multilingual"); ?>
<?php __("Bottom Left", "etranslation-multilingual"); ?>
<?php __("Top Right", "etranslation-multilingual"); ?>
...
<?php __("Anchor link", "etranslation-multilingual"); ?>
...
<?php __("You have unsaved changes!", "etranslation-multilingual"); ?>
<?php __("Discard changes", "etranslation-multilingual"); ?>
<?php __("Discard All", "etranslation-multilingual"); ?>
<?php __("Loading Strings...", "etranslation-multilingual"); ?>
<?php __("Select string to translate...", "etranslation-multilingual"); ?>
<?php __("Close Editor", "etranslation-multilingual"); ?>
<?php __("From", "etranslation-multilingual"); ?>
<?php __("To", "etranslation-multilingual"); ?>
<?php __("Next", "etranslation-multilingual"); ?>
...
<?php __("Translate entire block element", "etranslation-multilingual"); ?>
<?php __("Split block to translate strings individually", "etranslation-multilingual"); ?>
<?php __("Save changes to translation. Shortcut: CTRL(⌘) + S", "etranslation-multilingual"); ?>
<?php __("Navigate to next string in dropdown list. Shortcut: CTRL(⌘) + ALT + Right Arrow", "etranslation-multilingual"); ?>
<?php __("Navigate to previous string in dropdown list. Shortcut: CTRL(⌘) + ALT + Left Arrow", "etranslation-multilingual"); ?>
<?php __("Discard all changes. Shortcut: CTRL(⌘) + ALT + Z", "etranslation-multilingual"); ?>
<?php __("Discard changes to this text box. To discard changes to all text boxes use shortcut: CTRL(⌘) + ALT + Z", "etranslation-multilingual"); ?>
<?php __("Dismiss tooltip", "etranslation-multilingual"); ?>
...
<?php __("Extra Translation Features", "etranslation-multilingual"); ?>
<?php __("Support for 221 Extra Languages", "etranslation-multilingual"); ?>
<?php __("Yoast SEO support", "etranslation-multilingual"); ?>
<?php __("Translate SEO Title, Description, Slug", "etranslation-multilingual"); ?>
<?php __("Publish only when translation is complete", "etranslation-multilingual"); ?>
<?php __("Translate by Browsing as User Role", "etranslation-multilingual"); ?>
<?php __("Different Menu Items for each Language", "etranslation-multilingual"); ?>
<?php __("Automatic User Language Detection", "etranslation-multilingual"); ?>
<?php __("Supported By Real People", "etranslation-multilingual"); ?>
<?php __("Find Out More", "etranslation-multilingual"); ?>
...
<?php __("Your %s license has <span class=\"trp-license-status-emphasized\">expired</span>.", "etranslation-multilingual"); ?>
<?php __("Please renew your license to continue receiving access to product downloads, automatic updates and support.", "etranslation-multilingual"); ?>
<?php __("Renew Now", "etranslation-multilingual"); ?>
<?php __("Your %s license was <span class=\"trp-license-status-emphasized\">refunded</span>.", "etranslation-multilingual"); ?>
<?php __("Please purchase a new license to continue receiving access to product downloads, automatic updates and support.", "etranslation-multilingual"); ?>
<?php __("Purchase a new license", "etranslation-multilingual"); ?>
<?php __("Your %s license is <span class=\"trp-license-status-emphasized\">empty or incorrect</span>.", "etranslation-multilingual"); ?>
<?php __("Please enter a valid license to continue receiving access to product downloads, automatic updates and support.", "etranslation-multilingual"); ?>
<?php __("Enter a valid license", "etranslation-multilingual"); ?>
<?php __("Slugs", "etranslation-multilingual"); ?>
<?php __("Meta Information", "etranslation-multilingual"); ?>
<?php __("String List", "etranslation-multilingual"); ?>
<?php __("Gettext Strings", "etranslation-multilingual"); ?>
...
<?php __("The SEO Pack add-on allows translation of all the URL slugs:", "etranslation-multilingual"); ?>
...
<?php __("The SEO Pack add-on is available with ALL premium versions of the plugin.", "etranslation-multilingual"); ?>
...
<?php __("OG Description", "etranslation-multilingual"); ?>
<?php __("OG Image Alt", "etranslation-multilingual"); ?>
<?php __("Twitter Title", "etranslation-multilingual"); ?>
<?php __("Twitter Description", "etranslation-multilingual"); ?>
<?php __("Twitter Image Alt", "etranslation-multilingual"); ?>
<?php __("Page Title", "etranslation-multilingual"); ?>
<?php __("Dublin Core Title", "etranslation-multilingual"); ?>
<?php __("Dublin Core Description", "etranslation-multilingual"); ?>
<?php __("OG Image", "etranslation-multilingual"); ?>
<?php __("OG Image Secure URL", "etranslation-multilingual"); ?>
<?php __("Twitter Image", "etranslation-multilingual"); ?>
<?php __("Removing cdata dictionary strings for language %s...", "etranslation-multilingual"); ?>
<?php __("Removing untranslated dictionary links for language %s...", "etranslation-multilingual"); ?>
<?php __("Removing duplicated gettext strings for language %s...", "etranslation-multilingual"); ?>
<?php __("Removing untranslated gettext strings where translation is available for language %s...", "etranslation-multilingual"); ?>
<?php __("Removing duplicated dictionary strings for language %s...", "etranslation-multilingual"); ?>
<?php __("Removing untranslated dictionary strings where translation is available for language %s...", "etranslation-multilingual"); ?>
<?php __("Inserting original strings for language %s...", "etranslation-multilingual"); ?>
<?php __("Cleaning original strings table for language %s...", "etranslation-multilingual"); ?>
...
<?php __("Update aborted! Incorrect action.", "etranslation-multilingual"); ?>
<?php __("Update aborted! Incorrect language code.", "etranslation-multilingual"); ?>
<?php __("Updating database to version %s+", "etranslation-multilingual"); ?>
<?php __("Processing table for language %s...", "etranslation-multilingual"); ?>
<?php __("Back to eTranslation Multilingual Settings", "etranslation-multilingual"); ?>
<?php __("Successfully updated database!", "etranslation-multilingual"); ?>
<?php __(" done.", "etranslation-multilingual"); ?>
<?php __("eTranslation Multilingual", "etranslation-multilingual"); ?>
<?php __("<strong>eTranslation Multilingual</strong> requires <strong><a href=\"http://php.net/manual/en/book.mbstring.php\">Multibyte String PHP library</a></strong>. Please contact your server administrator to install it on your server.", "etranslation-multilingual"); ?>
<?php __("Detected long query limitation on WPEngine hosting. Some large pages may appear untranslated. You can remove limitation by adding the following to your site’s wp-config.php: define( 'WPE_GOVERNOR', false ); ", "etranslation-multilingual"); ?>
<?php __("Custom Language Flag", "etranslation-multilingual"); ?>
<?php __("The Language code of the added custom language is invalid.", "etranslation-multilingual"); ?>
...
<?php __("Browse As User Role", "etranslation-multilingual"); ?>
<?php __("Navigate your website just like a particular user role would. Really useful for dynamic content or hidden content that appears for particular users.", "etranslation-multilingual"); ?>
<?php __("Navigation Based on Language", "etranslation-multilingual"); ?>
<?php __("Configure different menu items for different languages.", "etranslation-multilingual"); ?>
<?php __("Recommended Plugins", "etranslation-multilingual"); ?>
<?php __("A short list of plugins you can use to extend your website.", "etranslation-multilingual"); ?>
<?php __("Profile Builder", "etranslation-multilingual"); ?>
<?php __("Capture more user information on the registration form with the help of Profile Builder's custom user profile fields and/or add an Email Confirmation process to verify your customers accounts.", "etranslation-multilingual"); ?>
<?php __("Paid Member Subscriptions", "etranslation-multilingual"); ?>
<?php __("Accept user payments, create subscription plans and restrict content on your membership site.", "etranslation-multilingual"); ?>
<?php __("eTranslation Multilingual Advanced Settings", "etranslation-multilingual"); ?>
...
<?php __("This feature is available only in the paid version. <a href=\"%1$s\" target=\"_blank\" title=\"%2$s\">%2$s</a> and unlock more premium features.", "etranslation-multilingual"); ?>
...
<?php __("Code", "etranslation-multilingual"); ?>
<?php __("Slug", "etranslation-multilingual"); ?>
<?php __("Default", "etranslation-multilingual"); ?>
<?php __("Formal", "etranslation-multilingual"); ?>
<?php __("Informal", "etranslation-multilingual"); ?>
...
<?php __("Select Yes if you want to display languages in their native names. Otherwise, languages will be displayed in English.", "etranslation-multilingual"); ?>
<?php __("Use a subdirectory for the default language", "etranslation-multilingual"); ?>
<?php __("Select Yes if you want to add the subdirectory in the URL for the default language.</br>By selecting Yes, the default language seen by website visitors will become the first one in the \"All Languages\" list.", "etranslation-multilingual"); ?>
<?php __("Force language in custom links", "etranslation-multilingual"); ?>
<?php __("Select Yes if you want to force custom links without language encoding to keep the currently selected language.", "etranslation-multilingual"); ?>
<?php __("Language Switcher", "etranslation-multilingual"); ?>
<?php __("Shortcode ", "etranslation-multilingual"); ?>
<?php __("Use shortcode on any page or widget.", "etranslation-multilingual"); ?>
<?php __("Menu item", "etranslation-multilingual"); ?>
<?php __("Go to  %1$s Appearance -> Menus%2$s to add languages to the Language Switcher in any menu.", "etranslation-multilingual"); ?>
<?php __("Learn more in our documentation.", "etranslation-multilingual"); ?>
<?php __("Floating language selection", "etranslation-multilingual"); ?>
<?php __("Add a floating dropdown that follows the user on every page.", "etranslation-multilingual"); ?>
<?php __("5 Days to Better Multilingual Websites", "etranslation-multilingual"); ?>
<?php __("Invalid email address", "etranslation-multilingual"); ?>
...
<?php __("Response:", "etranslation-multilingual"); ?>
<?php __("Response Body:", "etranslation-multilingual"); ?>
<?php __("Entire Response From wp_remote_get():", "etranslation-multilingual"); ?>
<?php __("Optimize eTranslation Multilingual database tables", "etranslation-multilingual"); ?>
<?php __("<strong>IMPORTANT NOTE: Before performing this action it is strongly recommended to first backup the database.</strong><br><br>", "etranslation-multilingual"); ?>
<?php __("IMPORTANT: It is strongly recommended to first backup the database!! Are you sure you want to continue?", "etranslation-multilingual"); ?>
<?php __("Operations to perform", "etranslation-multilingual"); ?>
<?php __("Remove CDATA for original and dictionary strings", "etranslation-multilingual"); ?>
<?php __("Removes CDATA from etm_original_strings and etm_dictionary_* tables.<br>This type of content should not be detected by eTranslation Multilingual. It might have been introduced in the database in older versions of the plugin.", "etranslation-multilingual"); ?>
<?php __("Remove untranslated links from dictionary tables", "etranslation-multilingual"); ?>
<?php __("Removes untranslated links and images from all etm_dictionary_* tables. These tables contain translations for user-inputted strings such as post content, post title, menus etc.", "etranslation-multilingual"); ?>
<?php __("Remove duplicate rows for gettext strings", "etranslation-multilingual"); ?>
<?php __("Cleans up all etm_gettext_* tables of duplicate rows. These tables contain translations for themes and plugin strings.", "etranslation-multilingual"); ?>
<?php __("Remove duplicate rows for dictionary strings", "etranslation-multilingual"); ?>
<?php __("Cleans up all etm_dictionary_* tables of duplicate rows. These tables contain translations for user-inputted strings such as post content, post title, menus etc.", "etranslation-multilingual"); ?>
<?php __("Remove duplicate rows for original dictionary strings", "etranslation-multilingual"); ?>
<?php __("Cleans up all etm_original_strings table of duplicate rows. This table contains strings in the default language, without any translation.<br>The etm_original_meta table, which contains meta information that refers to the post parent’s id, is also regenerated.<br>Such duplicates can appear in exceptional situations of unexpected behavior.", "etranslation-multilingual"); ?>
<?php __("Optimize Database", "etranslation-multilingual"); ?>
<?php __("eTranslation Multilingual Database Updater", "etranslation-multilingual"); ?>
<?php __("Updating eTranslation Multilingual tables", "etranslation-multilingual"); ?>
...
<?php __("Automatic translation code", "etranslation-multilingual"); ?>
<?php __("Flag URL", "etranslation-multilingual"); ?>
<?php __("Text RTL", "etranslation-multilingual"); ?>
...
<?php __("It disables search indexing the post content in translated languages.<br/>Useful when the content of the post doesn't allow HTML thus breaking the page.", "etranslation-multilingual"); ?>
<?php __("Do not translate certain paths", "etranslation-multilingual"); ?>
...
<?php __("Enable translation of numbers ( e.g. phone numbers)", "etranslation-multilingual"); ?>
<?php __("Selector", "etranslation-multilingual"); ?>
<?php __("Exclude from dynamic translation", "etranslation-multilingual"); ?>
...
<?php __("Gettext String", "etranslation-multilingual"); ?>
<?php __("Domain", "etranslation-multilingual"); ?>
<?php __("Exclude Gettext Strings", "etranslation-multilingual"); ?>
<?php __("Exclude these strings from being translated as Gettext strings by eTranslation Multilingual. Leave the domain empty to take into account any Gettext string.<br/>Can still be translated through po/mo files.", "etranslation-multilingual"); ?>
<?php __("Exclude selectors only from automatic translation", "etranslation-multilingual"); ?>
<?php __("Do not automatically translate strings that are found in html nodes matching these selectors.<br>Excludes all the children of HTML nodes matching these selectors from being automatically translated.<br>Manual translation of these strings is still possible.", "etranslation-multilingual"); ?>
<?php __("Exclude selectors from translation", "etranslation-multilingual"); ?>
<?php __("Do not translate strings that are found in html nodes matching these selectors.<br>Excludes all the children of HTML nodes matching these selectors from being translated.<br>These strings cannot be translated manually nor automatically.", "etranslation-multilingual"); ?>
<?php __("String", "etranslation-multilingual"); ?>
...
<?php __("Remove Country Locale", "etranslation-multilingual"); ?>
...
<?php __("Debug", "etranslation-multilingual"); ?>
<?php __("Miscellaneous options", "etranslation-multilingual"); ?>
...
<?php __("Delete entries", "etranslation-multilingual"); ?>
...
<?php __("See More", "etranslation-multilingual"); ?>
...
<?php __("You are about to perform this action on all the strings matching your filter, not just the visibly checked. To perform the action only to the visible strings click \"Select Visible\" from the table header dropdown.", "etranslation-multilingual"); ?>
<?php __("You are about to perform this action only on the visible strings. To perform the action on all the strings matching the filter click \"Select All\" from the table header dropdown.", "etranslation-multilingual"); ?>
<?php __("To continue please type the word:", "etranslation-multilingual"); ?>
<?php __("The word typed was incorrect. Action was cancelled.", "etranslation-multilingual"); ?>
<?php __("in", "etranslation-multilingual"); ?>
<?php __("Warning: This action cannot be undone. Deleting a string will remove its current translation. The original string will appear again in this interface after eTranslation Multilingual detects it. This action is NOT equivalent to excluding the string from being translated again.", "etranslation-multilingual"); ?>
<?php __("Navigate to next page", "etranslation-multilingual"); ?>
<?php __("Navigate to previous page", "etranslation-multilingual"); ?>
<?php __("Navigate to first page", "etranslation-multilingual"); ?>
<?php __("Navigate to last page", "etranslation-multilingual"); ?>
<?php __("Type a page number to navigate to", "etranslation-multilingual"); ?>
...
<?php __("Post Slug", "etranslation-multilingual"); ?>
<?php __("First by browser language, then IP address (recommended)", "etranslation-multilingual"); ?>
<?php __("First by IP address, then by browser language", "etranslation-multilingual"); ?>
<?php __("Only by browser language", "etranslation-multilingual"); ?>
<?php __("Only by IP address", "etranslation-multilingual"); ?>
<?php __("A popup appears asking the user if they want to be redirected", "etranslation-multilingual"); ?>
<?php __("Redirect directly (*not recommended)", "etranslation-multilingual"); ?>
<?php __("Pop-up window over the content", "etranslation-multilingual"); ?>
<?php __("Hello bar before the content", "etranslation-multilingual"); ?>
<?php __("WARNING. Cannot determine your language preference based on your current IP.<br>This is most likely because the website is on a local environment.", "etranslation-multilingual"); ?>
<?php __("Go to <a href=\"%s\" target=\"_self\">Advanced</a> tab to change this feature's settings", "etranslation-multilingual"); ?>
<?php __("Method of language detection", "etranslation-multilingual"); ?>
<?php __("Select how the language should be detected for first time visitors.<br>The visitor's last displayed language will be remembered through cookies.", "etranslation-multilingual"); ?>
<?php __("Pop-up to notify the user of the detected language", "etranslation-multilingual"); ?>
<?php __("Select the type of pop-up you wish to appear.", "etranslation-multilingual"); ?>
<?php __("Write the text you wish to appear in the pop-up.", "etranslation-multilingual"); ?>
<?php __("The same text is displayed in all languages. <br>A selecting language switcher will be appended to the pop-up. The detected language is pre-selected.", "etranslation-multilingual"); ?>
...
<?php __("The request is too long.", "etranslation-multilingual"); ?>
...
<?php __("Taxonomy", "etranslation-multilingual"); ?>
<?php __("Filter by Taxonomy", "etranslation-multilingual"); ?>
<?php __("Post Slugs", "etranslation-multilingual"); ?>
<?php __("Search Post Slugs", "etranslation-multilingual"); ?>
<?php __("Post ID", "etranslation-multilingual"); ?>
<?php __("Post Type", "etranslation-multilingual"); ?>
<?php __("Filter by Post Type", "etranslation-multilingual"); ?>
<?php __("Published", "etranslation-multilingual"); ?>
<?php __("Any Post Status", "etranslation-multilingual"); ?>
<?php __("Post Type Base Slugs", "etranslation-multilingual"); ?>
<?php __("Post Type Base Slug", "etranslation-multilingual"); ?>
<?php __("Search Post Type Base Slugs", "etranslation-multilingual"); ?>
<?php __("WooCommerce Slugs", "etranslation-multilingual"); ?>
