...
class ETM_Upgrade {
	...
	public function get_updates_details(){
		return apply_filters( 'etm_updates_details',
			array(
	...
	public function enqueue_update_script( $hook ) {
		if ( $hook === 'admin_page_etm_update_database' ) {
			wp_enqueue_script( 'etm-update-database', ETM_PLUGIN_URL . 'assets/js/etm-update-database.js', array(
				'jquery',
			), ETM_PLUGIN_VERSION );
		}

		wp_localize_script( 'etm-update-database', 'etm_updb_localized ', array(
