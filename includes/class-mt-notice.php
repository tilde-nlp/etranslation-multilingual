            ...
            if ($TRP_LANGUAGE != $default) {
                ...
                <div class="mt-notice-container">
                    <div class="translation-notice">
                        Page machine translation provided by <a class="mt-notice-link" href="https://ec.europa.eu/info/index_en">eTranslation Multilingual</a>. Show <a href="<?php echo $original_url ?>" class="mt-notice-link">original</a> content
                    </div>
